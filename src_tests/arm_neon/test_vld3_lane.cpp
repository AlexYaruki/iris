...
template <typename T>
void test_vld3_lane(T(*func)(typename T::vectorType::elementType*,T,int32_t)){
...
int main() {
    test_vld3_lane(vld3_lane_u8);
    test_vld3_lane(vld3_lane_u16);
    test_vld3_lane(vld3_lane_u32);

    test_vld3_lane(vld3_lane_s8);
    test_vld3_lane(vld3_lane_s16);
    test_vld3_lane(vld3_lane_s32);

    test_vld3_lane(vld3_lane_f32);

    test_vld3_lane(vld3q_lane_u8);
    test_vld3_lane(vld3q_lane_u16);
    test_vld3_lane(vld3q_lane_u32);

    test_vld3_lane(vld3q_lane_s8);
    test_vld3_lane(vld3q_lane_s16);
    test_vld3_lane(vld3q_lane_s32);

    test_vld3_lane(vld3q_lane_f32);
}
